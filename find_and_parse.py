...
class Invoice_parser:
    """
        Invoice_parser Object Initiation
    """
    ...
    def parse_data(self,curr_conf,data):
        ...
        :param curr_conf: Current Configuration
        :param data: Images data
        :return: json containing image data
        """
    ...
    def parse_invoice_number(self,keys_to_find,data):
        """
        :param keys_to_find:Fuzzy Spellings of Invoice Number from Config
        :param data: Data from Images
        :return: None (put invoice_no in Json)
        """
    ...
    def parse_balance(self,keys_to_find,data):
        """
        :param keys_to_find: Fuzzy Spellings of Balances from Config
        :param data: Data from Images
        :return: None (put total_balance in Json)
        """
        for key in keys_to_find:
    ...
    def parse_date(self,index,keys_to_find,data):
        """
        :param keys_to_find: Fuzzy Spellings of Dates from Config
        :param data: Data from Images
        :return: None (put invoice_date and due_date in Json)
        """
        for key in keys_to_find:
            result = process.extract(key, data)
    ...
    def convert_to_date_format(self,str_data):
        """
        :param str_data:Data from process.extract method
        :return: None
        """
    ...
    def truncate_empty_lines(self):
        """
        This method will truncate Empty lines and spaces from text files generated by Tesseract
        :return:None
        """
...
def get_files_in_folder(folder, include_hidden=False):
    """
    :param folder:Folder of text files
    :param include_hidden: Check to see if hidden files are included or not
    :return: text files
    """
...
def ocr_receipts(config, receipt_files):
    """
    :param config:Config File(configuration.yaml)
    :param receipt_files: Text files to parse
    :return: None
    """
    list_of_data_obj = [];
    final_list = [];
...
def enhance_data_insert_db(image_list):
    """
    This method enhances the json objects in the final list
    :param image_list:list of json objects
    :return:Enhanced Data list
    """
    local_obj={}
    return_final_list=[];
